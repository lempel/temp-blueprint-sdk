...
public class ZipFileHandler {
    ...
    /**
     * @param fileName target's path
     * @param mode     true: read mode, false: write mode
     ...
     * @throws IOException
     */
    public void getFile(final String sourcePath, final String targetPath) throws IOException {
        // read mode only
        if (ioMode) {
            open();
    ...
    protected void saveFile(ZipEntry entry, String fileName) throws IOException {
        // read mode only
        if (ioMode) {
            return;
        }
